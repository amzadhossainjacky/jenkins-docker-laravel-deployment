                    ...
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route(\Request::segment(1) . '.roles.update', $model->id) }}">
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <input type="text" class="form-control custom-bg" id="name" name="name"
                                    ...
                                    <div class="col-6">
                                        <input type="text" class="form-control custom-bg" id="route_segment"
                                            name="route_segment" value="{{ $model->route_segment }}" readonly>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="d-md-flex d-grid align-items-center gap-3">
                                            <button type="submit" class="save-btn" name="update"><i
