            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-info card-outline">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form method="post" action="{{ route(\Request::segment(1) . '.exams.update', $model->id) }}">
                                @csrf
                                <div class="row">
                                    <div class="col-12 col-lg-8">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-6 mb-2">
                                                <div class="input-group">
                                                    <input type="text" id="total_num_of_questions"
                                                        name="total_num_of_questions" class="form-control" value="{{$model->total_num_of_questions}}">
                                                </div>
                                            ...
                                            <div class="col-12 col-md-6 mb-2">
                                                <div class="input-group">
                                                    <input type="number" id="time_per_question" name="time_per_question" class="form-control" value="{{$model->time_per_question}}">
                                                </div>
                                            ...
                                            <div class="col-12 col-md-6 mb-2">
                                                <div class="input-group">
                                                    <input type="number" id="passing_percentage" name="passing_percentage" class="form-control" value="{{$model->passing_percentage}}">
                                                </div>
                                            ...
                                            <div class="col-12 col-md-6 mb-2 mb-sm-0">
                                                <div class="input-group">
                                                    <input type="datetime-local" id="start_time" name="start_time"
                                                        class="form-control" value="{{$model->start_time}}">
                                                </div>
                                            ...
                                            <div class="col-12 col-md-6 mb-0 mb-lg-2">
                                                <div class="input-group">
                                                    <input type="datetime-local" id="end_time" name="end_time"
                                                        class="form-control"  value="{{$model->end_time}}">
                                                </div>
                                    ...
                                    <div class="col-12 col-lg-4">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="input-group">
                                                    <textarea id="description" name="description" class="form-control" cols="30" rows="7" spellcheck="false">{{ $model->description }}</textarea>
                                                </div>
