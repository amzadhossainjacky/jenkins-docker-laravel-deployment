                ...
                <div class="col-12">
                    <div class="card card-info card-outline">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                @can('learning-material-create')
                                    <a href="{{ route(\Request::segment(1) . '.learning.materials.create') }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.data-table').DataTable({
                ...
                ajax: "{{ route(Request::segment(1) . '.learning.materials') }}",
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
