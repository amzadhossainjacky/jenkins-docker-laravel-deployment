                ...
                <div class="col-12">
                    <div class="card card-info card-outline">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                @can('exam-question-set-create')
                                    <a href="{{ route(\Request::segment(1) . '.exam.question.sets.create') }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.data-table').DataTable({
                ...
                ajax: "{{ route(Request::segment(1) . '.exam.question.sets') }}",
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
